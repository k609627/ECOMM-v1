...
while ($row_cart=mysqli_fetch_array($run_cart)) {
	...
	while ($row_pro=mysqli_fetch_array($run_pro)) {
		...
		$insert_cus="insert into customer_order (customer_id,due_amount,invoice_no,qty,size,order_date,order_status) values ('$customer_id','$sub_total','$invoice_no','$qty','$size',NOW(),'$status')";
		...
		$run_pending_order=mysqli_query($con,$run_pending_order);
