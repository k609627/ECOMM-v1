<div class="box">
	<center>
		...
		<p>If you have any questions,please feel free to<a href="../contact-us.php"> contact-us</a>,our customer supoort is available to contact 24/7
		</p>
	</center>
	<hr>
		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td> <a href="confirm.php?order_id=<?php echo $order_id; ?>" target="_blank" class="btn btn-primary btn-sm">Confirmed</a> </td>
				</tr>
			<?php } ?>
			</tbody>
		</table>
