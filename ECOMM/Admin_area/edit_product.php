			...
			<div class="panel-body">
				<form class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<select name="cat" class="form-control">
								<option value="<?php echo $cat_id; ?>"><?php echo $cat_title; ?>
								</option>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<textarea name="product_desc" class="form-control" rows="6" cols="19"><?php echo $product_desc; ?></textarea>
						</div>
					</div>
...
if (isset($_POST['update'])) {
	...
	if($run_product){
		...
		echo "<script>window.open('admin_panel.php?view_product','_self')</script>";
	}
}
?>
